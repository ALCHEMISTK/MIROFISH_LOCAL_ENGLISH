            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes their content and automatically generates an ontology structure suitable for public opinion simulation (entity types + relation types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and the knowledge graph is built to extract entities and relations
                </div>
              </div>
...
const renderGraph = () => {
  ...
  // Draw edges (with a wide transparent click zone)
  ...
  simulation.on('tick', () => {
    // Update positions of all edges (visible line + transparent click zone)
...
html:not(.dark) .process-phase.active .phase-header {
  background: #FFF5F2;
}
...
html:not(.dark) .process-phase.completed .phase-header {
  background: #F2FAF6;
}
...
html:not(.dark) .ontology-progress {
  background: #FFF5F2;
