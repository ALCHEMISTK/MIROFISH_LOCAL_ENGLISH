    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world with up to <span class="highlight-orange">millions of Agents</span> based on the seeds of reality within it. Inject variables from a god's perspective to find <span class="highlight-code">"local optimal solutions"</span> in complex group interactions.
            </p>
            <p class="slogan-text">
              Let the future rehearse among the Agent swarm, let decisions prevail after a hundred simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity extraction & agent profile generation & simulation parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsing prediction needs & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent deeply interacts with the post-simulation environment using a rich toolset</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any agent in the simulation world & interact with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              >
                ...
                <div v-else class="file-list">
                  <div v-for="(file, index) in files" :key="file.name + file.size + file.lastModified" class="file-item">
