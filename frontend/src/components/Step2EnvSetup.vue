    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using context, automatically invokes tools to organize entities and relationships from the knowledge graph, initializes simulation agents, and assigns them unique behaviors and memories based on reality seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently sets world time flow rate, recommendation algorithms, each agent's active time slots, speech frequency, event triggers and other parameters based on simulation requirements and reality seeds
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish auto-plans simulation of <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> real-world hours, each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of real time</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For first-time runs, it is strongly recommended to switch to ‘Custom Mode’ to reduce simulation rounds for a quick preview and to reduce the risk of errors ➝</p>
                    </div>
                  </div>
                </div>
              </div>
...
// Log deduplication: track the last output key info
...
// Compute total number of related topics across all profiles
...
.badge.success { background: #1a2e1a; color: #66bb6a; }
.badge.processing { background: #FF5722; color: #FFF; }
.badge.pending { background: var(--c-surface-2); color: var(--c-text-muted); }
.badge.accent { background: #1a2033; color: #64b5f6; }

html:not(.dark) .badge.success { background: #E8F5E9; color: #2E7D32; }
html:not(.dark) .badge.pending { background: #F5F5F5; color: #999; }
html:not(.dark) .badge.accent { background: #E3F2FD; color: #1565C0; }
...
.minimal-slider {
  ...
  border-radius: 2px;
  outline: none;
  background-image: linear-gradient(var(--c-inverse-bg), var(--c-inverse-bg));
...
.minimal-slider::-webkit-slider-thumb {
  ...
  border-radius: 50%;
  background: var(--c-surface);
  border: 2px solid var(--c-inverse-bg);
  cursor: pointer;
