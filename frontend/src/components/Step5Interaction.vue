          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report generation agent, with access to 4 professional tools and complete MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state, using Global/Local Memory to provide deep cross-temporal attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth traversal reconstructing event propagation paths and capturing full information flow topology</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface optimized for quickly extracting node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that can conduct multi-turn parallel conversations with simulated individuals, collecting unstructured opinion and psychological data</div>
                  </div>
                </div>
              </div>
            </div>
...
const renderMarkdown = (content) => {
  ...
  // Clean <br> before paragraph tags following block elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering for non-consecutive ordered lists: maintain incrementing numbers when single <ol> items are separated by paragraph content
...
html:not(.dark) .survey-pill:hover {
  background: #D1FAE5;
  color: #065F46;
}
...
html:not(.dark) .agent-checkbox.checked {
  background: #F0FDF4;
}
...
/* Quote styles in chat/survey area */
