...
Reads parameters from a config file to run the simulation fully automatically
...
class TwitterSimulationRunner:
    ...
    async def run(self, max_rounds: int = None):
        ...
        # Enter command-waiting mode if configured
...
async def main():
    ...
    # Initialize logging config (using fixed filenames, cleaning old logs)
...
def setup_signal_handlers():
    ...
    Gives the program a chance to clean up resources normally (close database, environment, etc.)
    """
