...
Dynamically updates the Zep graph with agent activity from simulations.
"""
...
class AgentActivity:
    ...
    def _describe_quote_post(self) -> str:
        ...
        if original_content and original_author:
            ...
            base = f"quote-posted \"{original_content}\""
        elif original_author:
    ...
    def _describe_create_comment(self) -> str:
        ...
        if content:
            if post_content and post_author:
                ...
                return f"commented \"{content}\" on the post \"{post_content}\""
            elif post_author:
...
class ZepGraphMemoryUpdater:
    ...
    Monitors the simulation's actions log file and updates new agent activity
    to the Zep graph in real time. Activities are grouped by platform; once
    BATCH_SIZE activities have accumulated for a platform, they are sent to Zep
    in a batch.
    ...
    - Target user names for follows/mutes
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args will contain full context (e.g. post content, usernames).
