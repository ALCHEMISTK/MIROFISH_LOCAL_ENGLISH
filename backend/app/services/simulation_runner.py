...
from .lightrag_graph_memory_updater import ZepGraphMemoryManager
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        enable_graph_memory_update: bool = False,  # Whether to update activities to graph memory
        graph_id: str = None  # Graph ID (required when graph memory update is enabled)
    ) -> SimulationRunState:
        """
        Start simulation
        ...
        Args:
            ...
            enable_graph_memory_update: Whether to dynamically update Agent activities to graph memory
        ...
        try:
            ...
            # If max_rounds is specified, add to command line args
            ...
            # This fixes issues with third-party libraries (such as OASIS) reading files without specifying encoding
            env = os.environ.copy()
                ...
                for line in f:
                    ...
                    if line:
                        try:
                            ...
                            # If graph memory update is enabled, send activity to updater
                            if graph_updater:
    ...
    def get_all_actions(
        ...
        if not actions:
            ...
            actions = cls._read_actions_from_file(
                actions_log,
                default_platform=None,  # Old format should have platform field
                platform_filter=platform,
                agent_id=agent_id,
                round_num=round_num
            )
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this environment variable is absent and we still need to register
        ...
        # SIGHUP only exists on Unix (macOS/Linux); Windows does not have it
