...
class InsightForgeResult:
    ...
    # Results across multiple retrieval dimensions
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            f"## Panorama Search Results (Future Full-Picture View)",
            f"Query: {self.query}",
            f"\n### Statistics",
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts.append("\n### Interview Summary & Key Perspectives")
...
class ZepToolsService:
    ...
    4. interview_agents — in-depth interview (interview simulated agents, multi-perspective views)

    [Basic tools]
    - search_graph — graph semantic search
    - get_all_nodes — get all nodes in the graph
    - get_all_edges — get all edges (with temporal information)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges from the graph (paginated, with temporal information).
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Fetches all graph edges and filters those connected to the specified node.
        ...
        try:
            ...
            result = []
            for edge in all_edges:
                # Check if the edge is connected to the specified node (as source or target)
    ...
    def get_entity_summary(
        ...
        """
        Get the relationship summary for a specific entity.
    ...
    def get_simulation_context(
        ...
        # Filter entities that have actual types (not plain Entity nodes)
        entities = []
        for node in all_nodes:
    ...
    def insight_forge(
        ...
        # Get details for all related entities (full output, not limited)
        entity_insights = []
        ...
        # Step 4: Build all relationship chains (full output, not limited)
        relationship_chains = []
...
Return a JSON list of sub-questions."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios where you need to understand the full picture of an event or trace its evolution.
    ...
    def quick_search(
        ...
        1. Directly invokes Zep semantic search
    ...
    def interview_agents(
        ...
        5. Consolidates all interview results into an interview report
        ...
        Args:
            ...
            interview_requirement: Interview requirement description (unstructured, e.g. "learn how students view the incident")
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "Reply requirements:\n"
            "1. Answer naturally, do not invoke any tools.\n"
        ...
        try:
            ...
            # Dual-platform mode result format: {"twitter_0": {...}, "reddit_0": {...}, "twitter_1": {...}, ...}
    ...
    def _select_agents_for_interview(
        ...
        Returns:
            tuple: (selected_agents, selected_indices, reasoning)
                - selected_agents: Full info for the selected agents
                - selected_indices: Indices of selected agents (used for API call)
        ...
        system_prompt = """You are a professional interview planner. Your task is to select the most appropriate agents to interview based on the interview requirement.

Selection criteria:
1. The agent's identity/profession is relevant to the interview topic.
2. The agent may hold unique or valuable perspectives.
3. Select diverse viewpoints (e.g. supporters, opponents, neutrals, experts, etc.).
...
Please select at most {max_agents} agents most suitable for the interview and explain your reasoning."""
...
- Use quotation marks when citing interviewee statements.
